...
def oauth_callback(request):
    ...
    try:
        token_response = requests.post(
            settings.OAUTH_42_TOKEN_URL, data=token_data)
        ...
        user_response = requests.get(
            settings.OAUTH_42_API_URL, headers=headers)
        ...
        try:
            ...
            user = User(
                ...
                # Por defecto, usar el mismo login
...
def anonimize(request):
    ...
    # debug log print user_id ready for anonimize
